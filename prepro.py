from data_load import load_directory_data
...
def process_data(hp):
    ...
    train, test, label_to_num = load_directory_data(hp.data_file, hp.label_file)
    ...
    label_list = [int(i) for i in range(len(label_to_num))]
